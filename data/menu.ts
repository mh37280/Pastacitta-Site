...
export const fullMenuSections: MenuSection[] = [
  ...
  },
  {
    ...
    eyebrow: "Wood-fired",
    items: [
      { name: "Cheesy Garlic Pizza", description: "Cheese, garlic, and oregano.", price: { reg: "$12", lrg: "$18" } },
      { name: "Margherita", description: "Tomato sauce, mozzarella cheese, and herbs.", price: { reg: "$14", lrg: "$20" }, image: "/img/Pizza/Margarita.jpg" },
      { name: "Vegetarian Pizza", description: "Mushroom, capsicum, onion, olives, and eggplant.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/Vegetarian.jpg" },
      { name: "BBQ Chicken", description: "Chicken, onion, mushroom, and BBQ sauce.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/BBQ%20Chicken.jpg" },
      { name: "Chicken Pesto", description: "Pesto sauce base, mushroom, capsicum, onion, chicken, and feta cheese.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/Chicken%20Pesto.jpg" },
      { name: "Tandoori Chicken", description: "Tandoori chicken breast, capsicum, and olives.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/Tandoori.jpg" },
      { name: "Peri Peri Chicken", description: "Chicken, mushroom, capsicum, onion, and peri peri sauce.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/Peri%20peri.jpg" },
      { name: "Supreme Pizza", description: "Pepperoni, mushroom, capsicum, onion, cabanossi, and olives.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/Supreme.jpg" },
      { name: "Hawaiian", description: "Meat rashers, pineapple, and cheese.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/Hawaiian.jpg" },
      { name: "Mexicana", description: "Pepperoni, capsicum, onion, olives, jalapenos, and chilli flakes.", price: { reg: "$18", lrg: "$24" }, image: "/img/Pizza/Mexicana.jpg" },
      { name: "Meat Lovers", description: "Pepperoni, capsicum, cabanossi, meat rashers, and BBQ sauce.", price: { reg: "$19", lrg: "$25" }, image: "/img/Pizza/Meat%20Lover.jpg" },
      { name: "Prawn Pizza", description: "King prawns, garlic, chilli, and herbs.", price: { reg: "$22", lrg: "$28" }, image: "/img/Pizza/Prawns.jpg" },
      { name: "Seafood", description: "Tomato base, mixed seafood, garlic, basil, oregano, and rocket.", price: { reg: "$22", lrg: "$28" } },
    ],
  },
  {
    id: "pasta-choice",
  ...
  },
  {
    ...
    eyebrow: "To finish",
    items: [
      { name: "Home Made Tiramisu", description: "House-made Italian dessert.", price: "$11", image: "/img/Desserts/Tiramisu.jpg" },
      { name: "Chocolate Mousse", description: "Rich chocolate finish.", price: "$11", image: "/img/Desserts/Chocolate.jpg" },
      { name: "Rice Pudding", description: "Creamy, slow-cooked rice pudding.", price: "$6", image: "/img/Desserts/Rice%20pudding.jpg" },
    ],
  },
  {
    id: "sides",
